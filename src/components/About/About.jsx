  ...
  return (
    <div ref={ref} className="w-full max-w-[90%] mx-auto my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <Link to="/about-us" key={""} className="group">
          <motion.div
          ...
          >
            <div className="text-4xl mb-3 text-info">
              {/* {iconMap[advantage.icon]} */}
            </div>
            <h3 className="text-xl font-semibold mb-2">sadadas</h3>
            <p className="text-sm opacity-80">asdaadd</p>
          </motion.div>
        </Link>
      </div>
    </div>
