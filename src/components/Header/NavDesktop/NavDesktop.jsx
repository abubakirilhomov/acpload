    ...
    <div className="shadow fixed w-full z-50 backdrop-blur-3xl">
      <div className="flex w-full max-w-[90%] mx-auto py-3 items-center justify-between">
        ...
        <div className="flex gap-4 items-center">
          <button className="btn hover:bg-[#3f96d1] btn-outline hover:text-white px-5 rounded-full">
            {loginLabel}
          </button>
          <button className="bg-[#3f96d1] btn border-info hover:text-white px-5 rounded-full">
            {signupLabel}
          </button>
          <div className="dropdown dropdown-end">
            <div
              tabIndex={0}
              role="button"
              className="btn rounded-full bg-[#3f96d1] p-3"
            >
