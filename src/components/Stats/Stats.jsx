  ...
  return (
    <section id="stats-section" className="py-24 px-8 flex justify-center items-center">
      <motion.div
        ...
        className="w-full max-w-5xl border-b-indigo-800 shadow-blue-700 rounded-3xl p-12 shadow-2xl text-white text-center"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {statsData.map((stat, i) => (
            <motion.div
              ...
              className="p-8 bg-blue-900 rounded-xl shadow-lg flex flex-col items-center border border-blue-700"
            >
              {iconMap[stat.key]}
