...
const NavDesktop = () => {
  ...
  const navLinks = {
    platform: [
      ...
      { title: t("navfooter.trucker-calculator"), link: "/platform/trucker-calculator" },
      { title: t("navfooter.freight-rate-calculator"), link: "/platform/freight-rate-calculator" },
      { title: t("navfooter.terms-and-conditions"), link: "/platform/terms-of-service" },
    ],
    company: [
      { title: t("navfooter.about-us"), link: "/our-company/about-us" },
      { title: t("navfooter.leadership"), link: "/our-company/leadership" },
      { title: t("navfooter.testimonials-and-reviews"), link: "/our-company/testimonials-reviews" },
      { title: t("navfooter.support-center"), link: "/our-company/support-center" },
    ...
    solutions: [
      { title: t("navfooter.carrier-dispatcher"), link: "/solutions/carrier-dispatcher" },
    ...
    resources: [
      { title: t("navfooter.freight-and-logistics-blog"), link: "/resources/freight-logistics-blog" },
      { title: t("navfooter.partnership-and-affiliate"), link: "/resources/partnership-affiliate" },
      { title: t("navfooter.newsletter-subscription"), link: "/resources/newsletter-subscription" },
    ...
    <div className="shadow fixed w-full z-50 backdrop-blur-3xl">
      <div className="flex w-full max-w-[90%] mx-auto py-3 items-center justify-between">
        ...
        <div className="flex gap-4">
          <DropdownMenu title={t("navfooter.platform")} links={navLinks.platform} />
          <DropdownMenu title={t("navfooter.products")} links={navLinks.products} />
          <DropdownMenu title={t("navfooter.solutions")} links={navLinks.solutions} />
          <DropdownMenu title={t("navfooter.resources")} links={navLinks.resources} />
          <DropdownMenu title={t("navfooter.our-company")} links={navLinks.company} />
        </div>
