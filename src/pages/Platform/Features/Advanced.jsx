    ...
    <div className="relative w-full bg-black">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-60 z-10 flex flex-col items-center justify-center px-6 py-12 text-center">
        ...
        <p className="text-white text-sm md:text-lg max-w-3xl">
          <strong>Accurate Cost Estimation:</strong><br />
          • Optimized Pricing: Calculate competitive freight rates based on distance, fuel costs, load weight, and other key factors.<br />
          • Transparent Calculations: Ensure fairness and accuracy in your pricing, helping you negotiate better deals.<br /><br />
          <strong>User-Friendly Interface:</strong><br />
          • Easy Input: Simply enter your load details and let our calculator do the rest.<br />
          • Real-Time Results: Receive instant rate estimates to help you plan your shipments more effectively.
        </p>
      </div>
