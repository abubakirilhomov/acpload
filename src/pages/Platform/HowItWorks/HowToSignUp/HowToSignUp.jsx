    ...
    <section ref={ref} className="w-full h-full py-16 text-white text-center">
      ...
      <div className="max-w-[90%] w-full mx-auto flex flex-wrap justify-center gap-6">
        {steps.map((step, index) => (
          ...
          >
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 flex items-center justify-center text-white text-2xl font-bold bg-[#3f96d1] rounded-full shadow-lg">
              {step.number}
            </div>
