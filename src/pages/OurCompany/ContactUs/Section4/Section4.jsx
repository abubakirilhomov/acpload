...
import { FaEnvelope, FaTelegramPlane, FaInstagram, FaYoutube, FaLinkedinIn } from 'react-icons/fa';
  ...
  return (
    <section className="bg-[#14293d] py-16 px-4 text-center">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-white text-3xl md:text-4xl font-semibold mb-4">Connect With Us Online</h2>
        <p className="text-slate-300 max-w-xl mx-auto text-base md:text-lg">
          Your feedback is valuable. We look forward to hearing from you and supporting your success in the US trucking and logistics industry!
        </p>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-10">
          {socialLinks.map((item, index) => (
            ...
            >
              <div className={`w-20 h-20 flex items-center justify-center rounded-full shadow-md ${item.bgColor}`}>
                {item.icon}
              </div>
