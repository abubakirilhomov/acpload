...
const Section4 = () => {
    return (
        <div className="bg-blue-400/10 flex flex-col lg:flex-row justify-center items-start p-4 md:p-6 gap-8">
            <div className="flex flex-col items-start justify-center mt-6 lg:mt-12 w-full lg:w-1/2">
                <h1 className="text-3xl md:text-4xl font-semibold mb-6 md:mb-12">Submit a Request</h1>
                <div className="bg-[#3e5364] p-6 md:p-8 w-full mt-4 lg:mt-12 lg:mr-12 rounded">
