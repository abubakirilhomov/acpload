    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 py-12 lg:py-0">
          <motion.div
            ...
            className="w-full lg:w-[600px] bg-[#3f96d1]/50 rounded-2xl p-6 sm:p-8 flex flex-col justify-center items-start"
          >
            <motion.h1
              variants={itemVariants}
              className="text-white text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6"
            >
              {t("carrier.title")}
            </motion.h1>
            <motion.p
            ...
            <motion.button
              ...
              className="bg-[#3f96d1] text-white py-3 px-6 rounded-lg font-medium w-full lg:w-auto mt-8 lg:mt-0 border-2 hover:bg-white hover:text-[#3f96d1] transition duration-300 ease-in-out hover:border-[#3f96d1]"
            >
            ...
            {[
              ...
              >
                <motion.div
                  ...
                  className="w-12 h-12 sm:w-14 sm:h-14 mb-3 sm:mb-4 rounded-full border-2 border-[#3f96d1] p-3 sm:p-4 flex items-center justify-center"
                >
                  {feature.icon}
                </motion.div>
      ...
      >
        <div className="container mx-auto">
          ...
          >
            {[
              {
                icon: <CheckCircle className="w-10 h-10 sm:w-12 sm:h-12 text-[#3f96d1]" />,
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2
            ...
            className="text-center font-bold text-white text-3xl sm:text-4xl mb-10 sm:mb-12 lg:mb-16"
          >
            {t("carrier.key-features.1.title")}
          </motion.h2>
          <div className="flex flex-col lg:flex-row justify-between gap-8 sm:gap-10">
            ...
            <motion.div
              ...
              className="w-full lg:w-1/2 space-y-4 sm:space-y-6 bg-gray-800 p-6 rounded-xl shadow-xl"
            >
              {[
                {
                  icon: (
                    <MdOutlineAccessTime className="w-5 h-5 sm:w-6 sm:h-6 text-[#3f96d1]" />
                  ),
                ...
                {
                  icon: (
                    <HiMiniCheckBadge className="w-5 h-5 sm:w-6 sm:h-6 text-[#3f96d1]" />
                  ),
                ...
                {
                  icon: (
                    <BsFillTicketPerforatedFill className="w-5 h-5 sm:w-6 sm:h-6 text-[#3f96d1]" />
                  ),
                ...
                {
                  icon: (
                    <BsCardChecklist className="w-5 h-5 sm:w-6 sm:h-6 text-[#3f96d1]" />
                  ),
                ...
                {
                  icon: (
                    <GiProgression className="w-5 h-5 sm:w-6 sm:h-6 text-[#3f96d1]" />
                  ),
      ...
      >
        <div className="container mx-auto">
          <motion.div
            variants={itemVariants}
            className="border-4 border-[#3f96d1] bg-gray-700 rounded-xl p-6 sm:p-8 lg:p-12 text-center max-w-6xl mx-auto"
          >
            <motion.h2
              variants={itemVariants}
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.05,
                backgroundColor: "#3f96d1",
                color: "white",
                borderColor: "#3f96d1",
              }}
              whileTap={{ scale: 0.95 }}
              className="border-2 text-[#3f96d1] border-[#3f96d1] py-2 sm:py-3 lg:py-4 px-6 sm:px-8 lg:px-12 rounded-xl text-base sm:text-lg lg:text-xl transition-all"
            >
              {t(
